...
public class YourEvaluator extends Evaluator {
    ...
    public YourEvaluator() {
        //Main.ce.
//        System.out.println(Main.ce);
//        System.out.println(Main.oe);
//        System.out.println(Main.ye);
        //Main.ye = new MyNoobEvaluator();
        //Main.ce = new MyNoobEvaluator();
    }
    ...
    public double eval(Position paramPosition) {
       // return Main.ce.eval(paramPosition);
        if (this == Main.oe) {
            return Main.ye.eval(paramPosition);
        } else if (this == Main.ye) {
            return Main.oe.eval(paramPosition);
        }
        //throw new UnsupportedOperationException("lol");

        return Main.ce.eval(paramPosition);
//        System.out.println("My eval:");
//        System.out.println("oe"+Main.oe);
//        System.out.println("ye"+Main.ye);
        //System.out.println(Main.oe);
